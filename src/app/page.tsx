      ...
      <nav className="nav">
        <div className="nav__wrapper">
          ...
          <ul className="nav__list--wrapper">
            <li className="nav__list nav__list--login" onClick={() => dispatch(toggleModal())}>Login</li>
          ...
          <div className="row">
            <div className="landing__wrapper">
              <div className="landing__content">
                ...
                <button className="btn home__cta--btn" onClick={() => dispatch(toggleModal())}>Login</button>
              </div>
            ...
            <div className="reviews__wrapper">
              <div className="review">
                ...
                <div className="review__body">
                  This app has been a <b>game-changer</b> for me! It&aposs saved me so
              ...
              <div className="review">
                ...
                <div className="review__body">
                  ...
                  easy to understand. It&aposs also very user-friendly and intuitive.
                </div>
              </div>
              <div className="review">
                <div className="review__header">
              ...
              <div className="review">
                ...
                <div className="review__body">
                  If you&aposre a busy person who
                  <b>loves reading but doesn&apost have the time</b> to read every
                  book in full, this app is for you! The summaries are thorough
                  and provide a great overview of the book&aposs content.
                </div>
              </div>
            </div>
